...
// Begin Class AC_Basic_AI Function AdjustDifficultySettings
struct Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics
{
	struct C_Basic_AI_eventAdjustDifficultySettings_Parms
	{
		FString Difficulty;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::NewProp_Difficulty = { "Difficulty", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(C_Basic_AI_eventAdjustDifficultySettings_Parms, Difficulty), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::NewProp_Difficulty,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AC_Basic_AI, nullptr, "AdjustDifficultySettings", nullptr, nullptr, Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::C_Basic_AI_eventAdjustDifficultySettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::C_Basic_AI_eventAdjustDifficultySettings_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AC_Basic_AI::execAdjustDifficultySettings)
{
	P_GET_PROPERTY(FStrProperty,Z_Param_Difficulty);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->AdjustDifficultySettings(Z_Param_Difficulty);
	P_NATIVE_END;
}
// End Class AC_Basic_AI Function AdjustDifficultySettings

// Begin Class AC_Basic_AI Function GetDamageDealt
struct Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics
{
	struct C_Basic_AI_eventGetDamageDealt_Parms
	{
		float ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(C_Basic_AI_eventGetDamageDealt_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AC_Basic_AI, nullptr, "GetDamageDealt", nullptr, nullptr, Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::PropPointers), sizeof(Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::C_Basic_AI_eventGetDamageDealt_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::Function_MetaDataParams), Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::C_Basic_AI_eventGetDamageDealt_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AC_Basic_AI::execGetDamageDealt)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(float*)Z_Param__Result=P_THIS->GetDamageDealt();
	P_NATIVE_END;
}
// End Class AC_Basic_AI Function GetDamageDealt

// Begin Class AC_Basic_AI Function GetHealth
struct Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics
{
	struct C_Basic_AI_eventGetHealth_Parms
	{
		float ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(C_Basic_AI_eventGetHealth_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AC_Basic_AI, nullptr, "GetHealth", nullptr, nullptr, Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::PropPointers), sizeof(Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::C_Basic_AI_eventGetHealth_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::Function_MetaDataParams), Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::C_Basic_AI_eventGetHealth_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AC_Basic_AI_GetHealth()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AC_Basic_AI_GetHealth_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AC_Basic_AI::execGetHealth)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class AC_Basic_AI Function GetHealth

// Begin Class AC_Basic_AI Function GetHealthDropChance
struct Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics
{
	struct C_Basic_AI_eventGetHealthDropChance_Parms
	{
		float ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(C_Basic_AI_eventGetHealthDropChance_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AC_Basic_AI, nullptr, "GetHealthDropChance", nullptr, nullptr, Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::PropPointers), sizeof(Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::C_Basic_AI_eventGetHealthDropChance_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::Function_MetaDataParams), Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::C_Basic_AI_eventGetHealthDropChance_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AC_Basic_AI::execGetHealthDropChance)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(float*)Z_Param__Result=P_THIS->GetHealthDropChance();
	P_NATIVE_END;
}
// End Class AC_Basic_AI Function GetHealthDropChance
...
void AC_Basic_AI::StaticRegisterNativesAC_Basic_AI()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "AdjustDifficultySettings", &AC_Basic_AI::execAdjustDifficultySettings },
		{ "GetDamageDealt", &AC_Basic_AI::execGetDamageDealt },
		{ "GetHealth", &AC_Basic_AI::execGetHealth },
		{ "GetHealthDropChance", &AC_Basic_AI::execGetHealthDropChance },
...
struct Z_Construct_UClass_AC_Basic_AI_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AC_Basic_AI_AdjustDifficultySettings, "AdjustDifficultySettings" }, // 3404883177
		{ &Z_Construct_UFunction_AC_Basic_AI_GetDamageDealt, "GetDamageDealt" }, // 1319188603
		{ &Z_Construct_UFunction_AC_Basic_AI_GetHealth, "GetHealth" }, // 3222572376
		{ &Z_Construct_UFunction_AC_Basic_AI_GetHealthDropChance, "GetHealthDropChance" }, // 3809161696
...
struct Z_CompiledInDeferFile_FID_Users_EdgeN_OneDrive_Documents_Unreal_Projects_Rokos_Basilisk_Game_Code_Source_TutorialProject_C_Basic_AI_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AC_Basic_AI, AC_Basic_AI::StaticClass, TEXT("AC_Basic_AI"), &Z_Registration_Info_UClass_AC_Basic_AI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AC_Basic_AI), 879559901U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_EdgeN_OneDrive_Documents_Unreal_Projects_Rokos_Basilisk_Game_Code_Source_TutorialProject_C_Basic_AI_h_209499094(TEXT("/Script/TutorialProject"),
